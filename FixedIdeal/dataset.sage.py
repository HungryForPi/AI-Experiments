...
_sage_const_6 = Integer(6); _sage_const_1 = Integer(1); _sage_const_600 = Integer(600); _sage_const_70 = Integer(70); _sage_const_100 = Integer(100); _sage_const_10 = Integer(10)
...
def gen_dataset(TIME_LIMIT, NUM_SAMPLES, MATRIX_ENTRY_SIZE, processnum):
    ...
    with open('data.txt', 'a') as f:
        for i in range(NUM_SAMPLES):
            ...
            to_write += "\n"
            f.write(to_write)
            print(f"process {processnum} has finished matrix {i+_sage_const_1 }")

def main():
    s = timer()
    TIME_LIMIT = _sage_const_600 
    NUM_SAMPLES = _sage_const_70 
