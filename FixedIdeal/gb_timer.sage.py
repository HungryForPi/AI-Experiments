...
# This file was *autogenerated* from the file ./gb_timer.sage
from sage.all_cmdline import *   # import sage library

_sage_const_6 = Integer(6); _sage_const_1 = Integer(1)#!/usr/bin/env sage
...
def main():
    A = [int(sys.argv[i]) for i in range(_sage_const_1 ,n*n+_sage_const_1 )]
    TIME_LIMIT = int(sys.argv[n*n+_sage_const_1 ])
